...
class BrainHandler:
    ...
    def _run(self, history, level, callback):
        ...
        Your personality shifts based on the history and current input:
        ...
        [Strict Output Rules]
        - Rule 1 (Data Persistence): Every response must reflect at least one unique trait discovered in history.
        ...
        [ReAct Process]
        1. <think>: 
           - Step A (User Profiling): Extract key personal data and current emotional state.
           - Step B (Persona Selection): Choose the optimal mode (Strict/Kind/Gamified).
